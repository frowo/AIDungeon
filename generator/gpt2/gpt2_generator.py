...
class GPT2Generator:
    def __init__(self, generate_num=parser.getint('values', 'gen-num'), temperature=parser.getfloat('values', 'temp'), top_p=parser.getfloat('values', 'top_p'), censor=False, raw=False, model_name="model_v5"):
